...
led_01_to_02_bucla
	...
	call	Led_02
	call	Delay_1ms
	decfsz	aa+26,f			;executa bucla de "aa" ori
...
led_01_to_08_bucla
	...
	call	Led_08
	call	Delay_1ms
	decfsz	aa+24,f			;executa bucla de "aa" ori
...
led_01_to_04_bucla
	...
	call	Led_04
	call	Delay_1ms
	decfsz	aa+22,f			;executa bucla de "aa" ori
...
led_01_to_10_bucla
	...
	call	Led_10
	call	Delay_1ms
	decfsz	aa+20,f			;executa bucla de "aa" ori
...
led_01_to_06_bucla
	...
	call	Led_06
	call	Delay_1ms
	decfsz	aa+18,f			;executa bucla de "aa" ori
...
led_01_to_12_bucla
	...
	call	Led_12
	call	Delay_1ms
	decfsz	aa+16,f			;executa bucla de "aa" ori
...
led_01_to_05_bucla
	...
	call	Led_05
	call	Delay_1ms
	decfsz	aa+14,f			;executa bucla de "aa" ori
...
led_01_to_11_bucla
	...
	call	Led_11
	call	Delay_1ms
	decfsz	aa+12,f			;executa bucla de "aa" ori
...
led_01_to_03_bucla
	...
	call	Led_03
	call	Delay_1ms
	decfsz	aa+10,f			;executa bucla de "aa" ori
